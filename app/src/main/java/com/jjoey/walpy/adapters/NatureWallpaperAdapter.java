...
public class NatureWallpaperAdapter extends RecyclerView.Adapter<WallpaperItemViewHolder> {
    ...
    private NatureImages natureImages;
    private View view;
    ...
    public void onBindViewHolder(final WallpaperItemViewHolder viewholder, final int position) {
        natureImages = (NatureImages) itemsList.get(position);

        Log.d(TAG, "Nature Key in NAdpater:\t" + prefsHelper.getKeyNature());

        Picasso.with(context)
                .load(natureImages.getLargeImgURL())
        ...
        viewholder.favoriteWP_IV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                favorites.setLargeImgURL(natureImages.getLargeImgURL());
                favorites.setPreviewImgURL(natureImages.getPreviewImgURL());

                List<Integer> favoritesList = new ArrayList<>();
                favoritesList.add(((NatureImages) itemsList.get(position)).getImgId());
                ...
                if (favoritesList.contains(favorites.getImageId())){
                    ...
                    Log.d(TAG, "Duplicate FavId in RecyclerList:\t" + ((NatureImages) itemsList.get(position)).getImgId());
                } else {
...
//                if (favorites.getImageId() == ((NatureImages) itemsList.get(position)).getImgId()) {
//                    Toast.makeText(context, "This Wallpaper Has Been Favorited", Toast.LENGTH_SHORT).show();
//                    Log.d(TAG, "Duplicate Id in Favorites:\t" + favorites.getImageId());
//                    Log.d(TAG, "Duplicate FavId in RecyclerList:\t" + ((NatureImages) itemsList.get(position)).getImgId());
//                } else {
//                    Log.d(TAG, "Favorites Id:\t" + favorites.getImageId());
//                    favorites.setImageId(((NatureImages) itemsList.get(position)).getImgId());
//                    favorites.save();
//                }
        ...
        viewholder.setWallPaper_TV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Picasso.with(context)
                        .load(((NatureImages) itemsList.get(position)).getLargeImgURL())
                        .into(new Target() {
                            @Override
